<div class="overlap-wrap-xs">
    ...
    <div class="overlap-body">
        <form id="ajax-administrative-form" data-method="post" data-route="actualizar?{{ request()->withQuery() }}" data-overlap-hide="#overapp">
            @csrf
            ...
            <div class="mb-2">
                ...
                <select name="department" id="department" class="form-select">
                    ...
                    <option value="{{ $department }}" @selected($data['department'] == $department)>
                        {{ $department }}
                    </option>
                    @endforeach
                </select>
